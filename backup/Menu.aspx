...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script>
        function moveToHotelPrice(supplierId, supplierName, areaId, areaName) {
            var d = new Date();

            window.location = 'HotelPriceManager.aspx?month=' + (d.getMonth() + 1) + '&year=' + d.getFullYear() + '&supplierId=' + supplierId + '&supplierName=' + supplierName + '&clerkId=' + $('#' + '<%= hiddenClerkId.ClientID %>').val() + "&areaId=" + areaId + '&areaName=' + areaName;
        }
    </script>
</asp:Content>
